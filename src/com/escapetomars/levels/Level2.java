...
public class Level2 extends JPanel implements ActionListener {
	...
	public Level2(JFrame frame, int playerScore, int highScore, int lives, int gameSpeed) {
	...
	private void initDisplayArea(JFrame frame) {
		...
		background = new Background(0, 0, 2);
		
		//set size of fireball - level 2 so 2 passed to collision detector
		collisionDetector = new CollisionDetector(2);
		...
		lblLives.setBounds(97, 11, 46, 26);
		add(lblLives);
	...
	private void initLetters() {
		...
		letters.add(new Digit1(2915, 303, 2));
	}
	...
	private void checkForNewLevel() {
		//for game use 12_200
		if(playerScore == 12_200){
			this.setVisible(false);
			updateable.update(5, playerScore, highScore, "", apache.getLives(), DELAY);
		}
	}

	private void updateLetters() {
		animateLetter(10_065, 10_250, 10_329, 10_330, 0);
		animateLetter(10_082, 10_260, 10_339, 10_340, 1);
		animateLetter(10_099, 10_270, 10_349, 10_350, 2);
		animateLetter(10_116, 10_280, 10_359, 10_360, 3);
		animateLetter(10_133, 10_290, 10_369, 10_370, 4);
		animateLetter(10_150, 10_300, 10_379, 10_380, 5);
	}
